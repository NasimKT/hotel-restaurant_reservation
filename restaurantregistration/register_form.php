    ...
    <div class="container">
        <form class="well form-horizontal" action="registrations.php" method="post" id="contact_form" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <legend>
                    <center>
                        <h2><b>Restaurant Registration</b></h2>
                    </center>
                </legend><br>
                ...
                <!-- Textarea input for About -->
                <div class="form-group">
                    <label class="col-md-4 control-label">About Restaurant</label>
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign"></i></span>
                            <textarea name="about" placeholder="About Restaurant" class="form-control"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <!-- Text input for Seating Capacity -->
                <div class="form-group">
                    <label class="col-md-4 control-label">Seating Capacity</label>
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <input name="seating_capacity" placeholder="Seating Capacity" class="form-control" type="text">
                        </div>
                    </div>
                </div>

                <!-- Text input for Table Count -->
                <div class="form-group">
                    <label class="col-md-4 control-label">Table Count</label>
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                            <input name="table_count" placeholder="Table Count" class="form-control" type="text">
                        </div>
                    </div>
                </div>

                <!-- Textarea input for Menu -->
                <div class="form-group">
                    <label class="col-md-4 control-label">Menu</label>
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-cutlery"></i></span>
                            <textarea name="menu" placeholder="Menu" class="form-control"></textarea>
                        </div>
                    </div>
                </div>
