...
<body>
    <div class="wrapper">
        ...
        <form action="signin.php" method="post" class="login" id="login">
            <div class="field">
        ...
        <form action="signup.php"  method="post" class="sign" id="sign">
            <div class="field">
                <input type="text" name="name" id="name" required>
                <label>Name</label>
            </div>
            <div class="field">
                <input type="text" name="sig_email" id="sig_email" required>
                <label>Email Address</label>
            </div>
            <div class="field">
                <input type="text" id="ph" name="phone" required>
                <label>Phone</label>
            </div>
            <div class="field">
                <input type="password" id="pas" name="sig_pass" oninput="verification()" required>
                <label>Password</label>
            </div>
            <div class="field">
                <input type="password" id="con_pas" oninput="verification()"required>
                <label>Confirm Password</label>
            </div>
            <div id="pas-match">Passwords should match!!</div>
            <div class="field">
                <input type="submit" value="Register" onclick="return validation()" required>
            </div>
            <div class="signup-link">
