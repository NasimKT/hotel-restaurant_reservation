...
if(isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    // Fetch the current verification status of the hotel
    $sql = "SELECT verified FROM hotel WHERE id = $id";
    ...
    if ($result->num_rows == 1) {
        ...
        $updateSql = "UPDATE hotel SET verified = $newVerificationStatus WHERE id = $id";
